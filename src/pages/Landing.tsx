...
const CRITICAL_IMAGES = [
  '/SocialSync AI Logo with Sync Arrow and Network Symbol.png',
...
export default function Landing() {
  ...
  const criticalImagesLoaded = useCriticalImagesPreload(CRITICAL_IMAGES);
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-500">
              See how SocialSync AI transforms your social media workflow
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-6 bg-white">
                ...
                <p className="text-gray-600">
                  ...
                  Save time and boost engagement with smart content suggestions.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="p-6 bg-white">
                ...
                <p className="text-gray-600">
                  Track performance across all platforms with detailed analytics.
                  Get AI-powered insights to improve your social media strategy.
                </p>
              </div>
            </div>
          </div>
